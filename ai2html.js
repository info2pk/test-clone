...
if (doc.documentColorSpace!="DocumentColorSpace.RGB") {
	...
	/*----------  NGM START  ----------*/
		var configFileFolder = docPath + docSettings.html_output_path 
		checkForOutputFolder(configFileFolder , "NGMConfigFileFolder");
		var configFile = new File( configFileFolder + "/config.json" );
		configFile.open( "w", "TEXT", "TEXT" );
			configFile.lineFeed = "Unix";
			configFile.encoding = "UTF-8";
			configFile.writeln(JSON.stringify({
				name: doc.name,
				time: dateTimeStamp
			}));
		configFile.close;
